...
function Yavin4StaticSpawnsScreenPlay:spawnMobiles()
	...
	-- DJK Ruins
	spawnMobile("yavin4", "dark_jedi_knight", 600, 5261.21, 9.56055, 3945.85, 146, 0)
	spawnMobile("yavin4", "dark_jedi_knight", 600, -0.0815785, -1.2976, 23.5849, 178, 620004357)
	spawnMobile("yavin4", "dark_jedi_knight", 600, 3.91434, -1.2976, -23.1872, 339, 620004357)
	spawnMobile("yavin4", "shadow_collective_disciple_of_maul", 1200, -0.0300821, -37.2976, -32.8633, 0, 620004357)
	spawnMobile("yavin4", "shadow_collective_fs_apprentice", 1500, -0.356848, -37.2976, 6.85759, 172, 620004357)
	...
	spawnMobile("yavin4", "trainer_padawan_dark", 1, -12.8204, -43.4244, -37.0648, 1, 3435634)
	spawnMobile("yavin4", "trainer_jedi_sabers_dark", 300, -44.5964, -43.4244, -28.9613, 118, 3435635)
	spawnMobile("yavin4", "trainer_jedi_defender_dark", 300, 13.401, -43.4244, -37.0122, 3, 3435634)
	spawnMobile("yavin4", "trainer_jedi_powers_dark", 300, 21.101, -43.4244, -37.0122, 3, 3435634)
	spawnMobile("yavin4", "trainer_jedi_healer_dark", 300, 6.09723, -43.4244, -56.8031, 189, 3435643)
	spawnMobile("yavin4", "trainer_jedi_form4_dark", 300, 4.09723, -43.4244, -56.8031, 189, 3435643)
	...
	spawnMobile("yavin4", "trainer_jedi_form4_light", 300, 19.886, -24, 85.4797, 178, 8525441)
