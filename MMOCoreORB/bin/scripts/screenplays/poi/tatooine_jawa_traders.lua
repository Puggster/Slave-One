...
function JawaTradersScreenPlay:spawnMobiles()
	...
	-- Additional Jawa...
	spawnMobile("tatooine", "jawa", 300, -6179.43, 7.00928, 1808.84, 3, 0)
	spawnMobile("tatooine", "jawa", 300, -6183.98, 7.17239, 1808.55, 40, 0)
	spawnMobile("tatooine", "jawa", 300, -6179.03, 7.13919, 1805.18, 63, 0)
	spawnMobile("tatooine", "jawa_protector", 300, -6213.85, 8.57265, 1845.6, 36, 0)
	spawnMobile("tatooine", "jawa", 300, -6217.67, 8.81972, 1847.44, 221, 0)
	spawnMobile("tatooine", "jawa", 300, -6209.46, 8.34892, 1838.19, 345, 0)
	spawnMobile("tatooine", "jawa_protector", 300, -6178.96, 6.94081, 1811.87, 134, 0)
	spawnMobile("tatooine", "jawa_protector", 300, -6131.26, 6.41506, 1811.2, 224, 0)
	spawnMobile("tatooine", "jawa", 300, -6138.23, 6.10457, 1836.49, 55, 0)
	spawnMobile("tatooine", "jawa", 300, -6138.12, 6.79554, 1864.11, 346, 0)
	spawnMobile("tatooine", "jawa", 300, -6108.45, 6.07214, 1851.29, 179, 0)
	spawnMobile("tatooine", "jawa", 300, -6103.86, 7.01689, 1874.45, 75, 0)
	spawnMobile("tatooine", "jawa_warlord", 300, -6117.53, 7.74243, 1879.89, 78, 0)
	spawnMobile("tatooine", "jawa_warlord", 300, -6134.31, 9.02673, 1889.45, 0, 0)
	spawnMobile("tatooine", "jawa", 300, -6135.09, 9.24805, 1891.61, 162, 0)
	spawnMobile("tatooine", "jawa_smuggler", 300, -6129.97, 7.01876, 1869.66, 174, 0)
	spawnMobile("tatooine", "jawa_smuggler", 300, -6120.01, 6.37804, 1860.12, 289, 0)
	spawnMobile("tatooine", "jawa_smuggler", 300, -6088.19, 9.7786, 1898.74, 66, 0)
	spawnMobile("tatooine", "jawa", 300, -6107.39, 9.9707, 1907.32, 46, 0)
	spawnMobile("tatooine", "jawa", 300, -6111.69, 9.30316, 1894.22, 97, 0)
	spawnMobile("tatooine", "jawa", 300, -6077.88, 6.89149, 1876.21, 86, 0)
	spawnMobile("tatooine", "jawa", 300, -6071.7, 8.41136, 1887.88, 129, 0)
	spawnMobile("tatooine", "jawa", 300, -6082.24, 10.5134, 1906.41, 126, 0)
	spawnMobile("tatooine", "jawa_protector", 300, -6106.88, 9.01879, 1891.65, 243, 0)
