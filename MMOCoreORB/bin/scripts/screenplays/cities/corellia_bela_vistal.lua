CorelliaBelaVistalScreenPlay = CityScreenPlay:new {
	...
	gcwMobs = {
		{"clonetrooper_captain", 6749.3, 315, -5684, 231.007, 0, "", true},
		{"clonetrooper_captain", 6718.1, 328.537, -5869.6, 186.005, 0, "", true},
		{"clonetrooper", 6663.8, 330, -5913.3, 134.004, 0, "", true},
		{"clone_scout_trooper", 6832.36, 314.758, -5811.93, 312.353, 0, ""},
		{"clone_commando", 6752.1, 315, -5823.5, 273.008, 0, ""},
		{"clone_commando", 6648.54, 330, -5939.32, 280.874, 0, ""},
		{"clonetrooper", 6852.9, 315, -5826.9, 140.004, 0, ""},
		{"clonetrooper", 6837.4, 315, -5774, 260.008, 0, ""},
		{"clonetrooper", 6819.9, 315, -5720.1, 220.006, 0, "", true},
		{"clonetrooper", 6748.9, 315, -5665.2, 279.008, 0, "", true},
		{"clonetrooper", 6855, 315, -5609.3, 280.008, 0, "", true},
		{"clonetrooper", 6685.7, 330, -5943.3, 222.007, 0, "", true},
		{"clonetrooper", 6708, 328.7, -5869.7, 166.005, 0, ""},
		{"clonetrooper_sniper", 6845.3, 315, -5826.8, 130.004, 0, "", true},
		{"clonetrooper_bombardier", 6646.02, 330, -5931.59, 357.677, 0, "", true},
		{"clonetrooper_bombardier", 6644.26, 330, -5937.08, 5.98245, 0, ""},
		{"clonetrooper_bombardier", 6649.56, 330, -5935.6, 128.564, 0, ""},
		{"clonetrooper_captain", 6854.5, 315, -5696.6, 87, 0, "npc_imperial", true},
		{"clonetrooper_squad_leader", 6650.38, 330, -5938.43, 280.869, 0, "npc_imperial"},
		{"clonetrooper", 6830.18, 314.823, -5816.91, 187.167, 0, "npc_imperial", true},
		{"clonetrooper_captain", 6820.49, 315, -5743.53, 353.468, 0, "npc_imperial"},
		{"clonetrooper_captain", 6832.21, 315, -5811.19, 189.637, 0, "npc_imperial"},
		{"clonetrooper_squad_leader", 6712.78, 315, -5810.38, 112.467, 0, "npc_imperial", true},
		{"clonetrooper_squad_leader", 6795.21, 315, -5702.92, 63.9209, 0, "npc_imperial", true},
		{"clonetrooper_squad_leader", 6823.92, 315, -5597.88, 121.846, 0, "npc_imperial", true},
		{"clonetrooper_squad_leader", 6908.17, 330, -5608.54, 27.4568, 0, "npc_imperial", true},
		{"clonetrooper_squad_leader", 6909.29, 330, -5606.48, 204.967, 0, "npc_imperial"},
		{"clonetrooper", 6727.1, 315, -5809.9, 165, 0, "npc_imperial", true},
		{"clonetrooper", 6707.89, 315, -5814.25, 131.647, 0, "npc_imperial"},
		{"clonetrooper", 6794.42, 315, -5696.6, 90.5594, 0, "npc_imperial"},
		{"clonetrooper", 6826.7, 315, -5820.68, 309.206, 0, "npc_imperial"},
		{"clonetrooper", 6825.35, 315, -5620.37, 277.216, 0, "npc_imperial", true},
		{"clonetrooper", 6842.92, 315, -5604.11, 56.0358, 0, "npc_imperial"},
		{"clonetrooper", 6852, 315, -5831.51, 128.695, 0, "npc_imperial"},
		{"clonetrooper", 6837.95, 315, -5806.84, 302.784, 0, "npc_imperial"},
	},
