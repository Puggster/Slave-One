CorelliaTyrenaScreenPlay = CityScreenPlay:new {
	...
	gcwMobs = {
		{"rep_jedi_knight", "cis_magnaguard", -5281.9, 21, -2574.6, 80, 0, "", "", true},
		{"rep_jedi_knight", "cis_magnaguard", -5112.1,21,-2279.3,79.0023,0, "", "", true},
		{"rep_jedi_knight", "cis_magnaguard", -5048.7,21,-2299.5,256.201,0, "", "", true},
		...
		{"clone_commando", "cis_battle_droid_commando", -5347.92,21.0054,-2440.31,351.468,0, "", ""},
		{"clone_commando", "cis_battle_droid_commando", -5654.8,21.1047,-2805.7,191.006,0, "", ""},
		{"clone_sand_trooper", "cis_battle_droid_commando", -5613.95,21,-2585.97,41.9991,0, "", ""},
		{"clone_sand_trooper", "cis_battle_droid_commando", -5606,21.6,-2777.2,82,0, "", ""},
		{"clonetrooper_captain", "cis_sbd", -5298.7,21,-2545.6,32,0, "", "", true},
		{"clonetrooper_captain", "cis_sbd", -5590.48,20.3776,-2854.51,311.192,0, "", "", true},
		{"clonetrooper", "cis_battle_droid", -5207.41,21.425,-2247.49,237.999,0, "", ""},
		{"clone_scout_trooper", "cis_battle_droid_specforce", -5128.84,21,-2652.86,83.2245,0, "", ""},
		{"clone_scout_trooper", "cis_battle_droid_specforce", -5208.06,21.6077,-2246.46,296.757,0, "", ""},
		{"clone_scout_trooper", "cis_battle_droid_specforce", -5194.27,20.9887,-2653.85,274.172,0, "", ""},
		{"clone_scout_trooper", "cis_battle_droid_specforce", -5468.4,21.1828,-2841.6,175.005,0, "", ""},
		{"clone_commando", "cis_battle_droid", -5342.53,21,-2468.78,360.011,0, "", "", true},
		...
		{"clonetrooper", "cis_battle_droid", -4944.3,21,-2387.8,257.008,0, "", "", true},
		...
		{"clonetrooper", "cis_battle_droid", -5135.07,20.9878,-2659.19,86.9316,0, "", "", true},
		...
		{"clonetrooper", "cis_battle_droid", -5343.5,21,-2471.7,271.008,0, "", "", true},
		{"clonetrooper", "cis_battle_droid", -5338.7,21,-2427.9,309.009,0, "", ""},
		{"clonetrooper", "cis_battle_droid", -5195.9,21,-2253.9,336.01,0, "", "", true},
		...
		{"clonetrooper", "cis_battle_droid", -5485.9,21,-2585.8,89.0026,0, "", "", true},
		{"clonetrooper", "cis_battle_droid", -4942.5,21,-2438.9,106.003,0, "", ""},
		{"clonetrooper", "cis_battle_droid", -5556.4,21.6,-2611.8,99.0029,0, "", ""},
		{"clonetrooper", "cis_battle_droid", -5112.07,21,-2248.89,97.4325,0, "", ""},
		{"clonetrooper", "cis_battle_droid", -5044.7,21,-2303,200.405,0, "", "", true},
		{"clonetrooper", "cis_battle_droid", -5131.1,21,-2417.7,6.00023,0, "", ""},
		{"clonetrooper", "cis_battle_droid", -5301.8,21,-2572,244.007,0, "", ""},
		{"clonetrooper", "cis_battle_droid", -5306.8,21,-2561.2,247.007,0, "", "", true},
		{"clonetrooper", "cis_battle_droid", -5399.6,21,-2608.8,241.007,0, "", "", true},
		{"clonetrooper", "cis_battle_droid", -5396.8,21,-2614.9,251.007,0, "", ""},
		{"clonetrooper", "cis_battle_droid", -5459.6,21.2742,-2841.6,185.005,0, "", ""},
		{"clonetrooper_bombardier", "cis_general", -5086.49,21,-2255.77,216.35,0, "npc_imperial", "conversation"},
		{"clonetrooper_medic", "rebel_medic", -5302.1,21,-2379.2,225.007,0, "", ""},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -5418.2,20.9379,-2799.6,243.757,0, "", ""},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -5556.4,21.6,-2643.5,79.0023,0, "", ""},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -5097.16,21,-2271.05,130.264,0, "npc_imperial", "neutral"},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -5123,21,-2425.3,67.002,0, "", ""},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -5245.9,20.9324,-2636.5,228.007,0, "", ""},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -5227.3,21,-2272.3,331.01,0, "", ""},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -5574.1,20.98,-2843.3,314.848,0, "", ""},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -4932.5,20.978,-2427.7,123.004,0, "", ""},
		{"clonetrooper_sniper", "cis_battle_droid_commando", -5094.14,21,-2270.16,45.8873,0, "npc_imperial", "neutral"},
		{"clonetrooper_squad_leader", "cis_battle_droid_captain", -5613.85,21,-2584,33.2059,0, "npc_imperial", "conversation"},
		{"clonetrooper_squad_leader", "cis_battle_droid_captain", -5103.81,21,-2266.4,126.218,0, "npc_imperial", "neutral", true},
	...
	mobiles = {
		...
		-- Ragtag Bunker
		{"ragtag_loon", 120, -4821.48, 12.2354, -2537.57, 331, 0, ""},
		{"ragtag_loon", 120, -4827.3, 12.0798, -2541.43, 306, 0, ""},
		{"ragtag_kook", 120, -0.160675, 0.25, 2.43491, 1, 620001708, ""},
		{"ragtag_kook", 120, 4.09676, 0.25, -1.47631, 350, 620001708, ""},
		{"ragtag_loon", 120, -4.67056, 0.25, -4.1661, 82, 620001709, ""},
		{"ragtag_thug", 120, -3.41861, -3.25, 5.69214, 180, 620001710, ""},
		{"ragtag_maniac", 120, 5.47458, -6.75, 5.82438, 182, 620001710, ""},
		{"ragtag_lunatic", 120, 6.61267, -6.75, -0.173969, 211, 620001711, ""},
		{"ragtag_lunatic", 120, 2.72549, -6.75, 0.167566, 171, 620001711, ""},
		{"ragtag_lunatic", 120, 2.53969, -6.75, -10.0254, 15, 620001711, ""},
		{"ragtag_maniac", 120, 5.54116, -6.75973, -6.92088, 355, 620001711, ""},
		{"ragtag_maniac", 120, 5.29987, -10.25, -19.2172, 314, 620001712, ""},
		{"ragtag_lunatic", 120, -3.51968, -13.75, -19.0804, 5, 620001712, ""},
		{"ragtag_maniac", 120, -6.77181, -13.75, -13.3081, 59, 620001713, ""},
		{"ragtag_thug", 120, -1.68886, -13.75, -13.2341, 335, 620001713, ""},
		{"ragtag_thug", 300, -2.02289, -13.75, -5.43314, 21, 620001713, ""},
		{"ragtag_loon", 120, -1.55375, -13.75, -3.26431, 185, 620001713, ""},
		{"ragtag_loon", 120, -3.25542, -13.7499, -0.670212, 289, 620001713, ""},
		{"ragtag_kook", 120, -6.39829, -13.7499, 6.37063, 162, 620001713, ""},
		{"ragtag_thug", 120, -1.91827, -13.7499, 7.2856, 201, 620001713, ""},
		{"ragtag_thug", 120, -6.21268, -13.7584, 11.652, 268, 620001714, ""},
		{"ragtag_thug", 120, 5.97342, -13.7584, 9.07191, 349, 620001714, ""},
		{"ragtag_maniac", 120, 8.69749, -13.7584, 14.0437, 232, 620001714, ""},
		{"ragtag_mercenary", 120, 15.9946, -13.7584, 15.1366, 324, 620001715, ""},
		{"ragtag_mercenary", 120, 13.9457, -13.7584, 4.69419, 282, 620001715, ""},
		{"ragtag_mercenary", 120, 16.501, -13.7584, 6.58621, 101, 620001715, ""},
		{"ragtag_maniac", 120, 12.8463, -13.7584, -0.699527, 52, 620001715, ""},
		{"ragtag_thug", 120, 17.8173, -13.7584, 0.0808916, 327, 620001715, ""},
		{"ragtag_thug", 120, 15.429, -13.7584, -16.7076, 176, 620001716, ""},
		{"ragtag_maniac", 120, 13.5321, -13.7584, -15.5541, 1, 620001716, ""},
		{"ragtag_mercenary", 120, 15.3306, -11.5, -20.3857, 340, 620001716, ""},
		{"ragtag_mercenary", 120, 12.1889, -11.5, -20.1469, 15, 620001716, ""}
	}
}
