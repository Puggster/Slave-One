TatooineAnchorheadScreenPlay = CityScreenPlay:new {
	...
	gcwMobs = {
		{"cis_battle_droid_specforce", 65.685, 52, -5349.49, -4, 0, "", true},
		{"cis_battle_droid_specforce", 49.2, 52, -5351, 350, 0, "", true},
		{"cis_battle_droid_specforce", 125.5, 52, -5416, 279.008, 0, "", true},
		{"cis_battle_droid_specforce", 55.2, 52.6, -5332.5, 184.005, 0, "", true},
		{"cis_sbd", 68, 52, -5382, 67, 0, "", true},
		{"cis_battle_droid_captain", 67, 52, -5366.5, 95, 0, "", true},
		{"cis_battle_droid_captain", 31.4, 51.1006, -5350.3, 203.975, 0, "", true},
		{"cis_battle_droid_specforce", 31, 51.9725, -5337, 270.008, 0, "", true},
		{"cis_battle_droid_specforce", 76.5, 52, -5361.1, 329.737, 0, "", true},
		{"cis_battle_droid_specforce", 135.1, 52, -5374.9, 83.0024, 0, "", true},
		{"cis_battle_droid_specforce", 123.6, 52, -5368, 235, 0, "", true},
		{"cis_battle_droid_specforce", 89.9, 52, -5393.8, 313.009, 0, "", true},
		{"cis_battle_droid_specforce", 151, 52, -5316, 37.8685, 0, "", true},
		{"cis_battle_droid_specforce", 159, 52, -5320, 331.012, 0, "", true},
	},
