CorelliaVreniIslandScreenPlay = CityScreenPlay:new {
	...
	gcwMobs = {
		{"cis_battle_droid_specforce", -5538.4, 16.4902, -6054.7, 182.005, 0, "", true},
		{"cis_major_general", -5533.2, 23.4, -6202.2, 46, 0, "", true},
		{"specops_agent", -5405, 25, -6220, 37, 0, "", true},
		{"cis_battle_droid", -5534.1, 23.4, -6217.9, 138.004, 0, "", true},
		{"rebel_recruiter", 0, -5516.1, 23.4, -6204.0, 0, 0, "", true},
		{"cis_battle_droid", -5549.5, 23.4, -6202.1, 310.009, 0, "", true},
		{"cis_battle_droid", -5549, 23.4, -6217.8, -139, 0, "", true},
		{"cis_battle_droid", -5429.8, 24, -6218.9, 0, 0, "", true},
		{"cis_battle_droid_squad_leader", -5411.4, 24.9599, -6219.3, 5.00012, 0, "", true},
		{"cis_battle_droid_specforce", -5398, 24.2, -6242.9, 81, 0, "", true},
		{"cis_battle_droid_specforce", -5443.6, 24, -6243, 282.008, 0, "", true},
		{"cis_battle_droid_specforce", -5716.1, 14.6, -6153.1, 269.008, 0, "", true},
		{"specops_agent", -5716.1, 14.6, -6147.5, 271.008, 0, "", true},
		{"cis_battle_droid_specforce", -5664, 14.6, -6179.3, 94.0028, 0, "", true},
		{"cis_battle_droid", -5664, 14.7566, -6185.3, 94.0028, 0, "", true},
		{"cis_battle_droid_specforce", -5290.0, 4.0, -6421.6, 0, 0, "", true},
		{"cis_battle_droid_specforce", -5290.0, 4.0, -6432.9, 180, 0, "", true},
		{"cis_battle_droid_specforce", -5149.3, 4.2, -6418.8, -90, 0, "", true},
		{"cis_battle_droid_specforce", -5160.1, 4.0, -6413.2, 90, 0, "", true},
	},
