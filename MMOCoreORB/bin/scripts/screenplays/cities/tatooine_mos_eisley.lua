TatooineMosEisleyScreenPlay = CityScreenPlay:new {
	...
	gcwMobs = {
		{"clonetrooper", "cis_battle_droid", 3410.5,5,-4735.8,-154,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3500.8,8,-4683.9,143,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3496.81,5.52789,-4923.13,352.589,0, "", "", true},
		{"clonetrooper", "cis_battle_droid", 3760.6,5,-4802,68,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3322.23,4.77649,-4623.57,331.647,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3304.54,5,-4602.49,86.0652,0, "", ""},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3288.68,4.72215,-4636.09,61.7463,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3278.49,4.75246,-4676.19,22.0117,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3290.4,5,-4696.4,137,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3427.14,5,-4952.92,91.6772,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3417.99,5,-4974.46,-54,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3538.04,5.12541,-4806.46,312.721,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3516.17,5,-4879.7,80,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3279.95,5,-4835.74,40,0, "", "", true},
		{"clone_sand_trooper", "cis_battle_droid_commando", 3341.8,5,-4750.9,124,0, "", "", true},
		{"clone_scout_trooper", "cis_battle_droid", 3585.84,5,-4719.95,281.969,0, "", "", true},
		{"clone_scout_trooper", "cis_battle_droid", 3288.12,4.9981,-4842.11,27.4222,0, "", "", true},
	...
	mobiles = {
		...
		{"clonetrooper",400,2.84,-0.894992,-6.3,16.0005,1082877, "npc_imperial"},
		{"clonetrooper_squad_leader",400,3.62,-0.894992,-6.78,360.011,1082877, "npc_accusing"},
		...
		{"clonetrooper",400,7.7,0,-7.6,229,1280131, "npc_imperial"},
		{"imperial_private",400,-7.3,0,-3.8,72,1280131, "npc_imperial"},
		{"imperial_recruiter",0,-0.86,0.4,-8,42,1280131, ""},
		{"clonetrooper_captain",400,-8.8,1,8.7,90,1280132, "npc_imperial"},
		...
		{"trainer_smuggler",0,3401,5,-4879,340,0, "worried"},
		 ...
		 -- Sandcrawler
		{"jawa", 120, 3738.97, 20.2532, -5206.08, 166, 0, ""},
		{"jawa", 120, 3738.56, 20.368, -5202.74, 138, 0, ""},
		{"jawa", 120, 3754.31, 17.0433, -5243.62, 219, 0, ""},
		{"jawa", 120, 3786.49, 18.2188, -5222.16, 288, 0, ""},
		{"jawa_warlord", 120, 3775, 19.5441, -5209.67, 87, 0, ""},
		{"jawa_warlord", 120, 3765.54, 21.3314, -5182.29, 277, 0, ""},
		{"jawa_warlord", 120, 3796.84, 17.8569, -5222.26, 10, 0, ""},
		{"jawa_henchman", 120, 3765.66, 17.7545, -5227.66, 286, 0, ""},
		{"jawa_henchman", 120, 3758.98, 16.527, -5230.14, 347, 0, ""},
		{"jawa_henchman", 120, 3735.69, 20.2333, -5186.88, 42, 0, ""},
		{"jawa_henchman", 120, 3748.42, 20.0078, -5188.99, 230, 0, ""},
		{"jawa_henchman", 120, 3762.03, 20.1813, -5189.26, 233, 0, ""},

		--Tusken Mini Bunker
		{"tusken_fighter", 300, 3285.69, 6.99844, -5182.58, 24, 0, ""},
		{"tusken_sniper", 300, 3280.84, 6.83105, -5181.32, 18, 0, ""},
		{"tusken_avenger", 300, 0.112943, 0.25, 2.86313, 2, 620001796, ""},
		{"tusken_avenger", 300, -3.7364, 0.25, -0.956214, 13, 620001796, ""},
		{"tusken_fighter", 300, -0.200796, 0.25, -4.18135, 77, 620001797, ""},
		{"tusken_avenger", 300, 3.33427, -3.25, 5.38766, 277, 620001798, ""},
		{"tusken_avenger", 300, -4.52976, -6.75, 4.59226, 172, 620001798, ""},
		{"tusken_avenger", 300, 4.00577, -13.75, -5.79963, 351, 620001799, ""},
		{"tusken_warlord", 300, -2.3139, -13.75, 7.52598, 118, 620001801, ""},
		{"tusken_avenger", 300, -6.39505, -17.25, -3.68399, 344, 620001802, ""},
		{"tusken_avenger", 300, -1.37622, -20.7332, 3.03223, 29, 620001803, ""},
		{"tusken_sniper", 300, 3.52831, -20.7332, 10.9502, 208, 620001803, ""},
		{"tusken_chief", 300, 5.2735, -20.7332, 5.09175, 274, 620001803, ""},
		{"tusken_king", 300, 1.61926, -20.75, 32.9795, 184, 620001804, ""},
		{"tusken_brute", 300, -2.37384, -20.75, 26.2466, 176, 620001804, ""},
		{"tusken_brute", 300, 4.30125, -20.75, 26.9237, 189, 620001804, ""},
		{"tusken_chief", 300, 4.53268, -20.75, 16.5959, 303, 620001804, ""},
		{"tusken_brute", 300, -9.64233, -13.75, 7.85202, 96, 620001801, ""}
	}
}
