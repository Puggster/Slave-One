...
DeathWatchBunkerScreenPlay = ScreenPlay:new {
	...
	terminalSkills = { "", "", "", "", "social_language_basic_comprehend", "social_language_basic_comprehend", "social_language_basic_comprehend", "social_language_basic_comprehend" },
...
function DeathWatchBunkerScreenPlay:checkDoor(pSceneObject, pCreature)
	...
	elseif doorType == 3 then
		...
		if (self:hasRequiredSkill(doorNumber, pCreature) == true) then
