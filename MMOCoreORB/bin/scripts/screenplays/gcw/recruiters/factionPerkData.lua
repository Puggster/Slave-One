...
rebelRewardData = {
	...
	weaponsArmor = {
	armor_sep_battle_bicep_l = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_bicep_l_schematic", item="object/tangible/loot/loot_schematic/sep_battle_bicep_l_crafted_schematic.iff",cost=10000},
	armor_sep_battle_bicep_r = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_bicep_r_schematic", item="object/tangible/loot/loot_schematic/sep_battle_bicep_r_crafted_schematic.iff",cost=10000},
	armor_sep_battle_boots = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_boots_schematic", item="object/tangible/loot/loot_schematic/sep_battle_boots_crafted_schematic.iff",cost=10000},
	armor_sep_battle_chest_plate = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_chest_schematic", item="object/tangible/loot/loot_schematic/sep_battle_chest_plate_crafted_schematic.iff", cost=10000},
	armor_sep_battle_helmet = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_helmet_schematic", item="object/tangible/loot/loot_schematic/sep_battle_helmet_crafted_schematic.iff", cost=10000},
	armor_sep_battle_leggings = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_leggings_schematic", item="object/tangible/loot/loot_schematic/sep_battle_leggings_crafted_schematic.iff",cost=10000},
	armor_sep_battle_bracer_l = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_bracer_l_schematic", item="object/tangible/loot/loot_schematic/sep_battle_bracer_l_crafted_schematic.iff",cost=10000},
	armor_sep_battle_bracer_r = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_bracer_r_schematic", item="object/tangible/loot/loot_schematic/sep_battle_bracer_r_crafted_schematic.iff",cost=10000},
	armor_sep_battle_gloves = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_gloves_schematic", item="object/tangible/loot/loot_schematic/sep_battle_gloves_crafted_schematic.iff",cost=10000},
	armor_sep_battle_utility_belt = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_sep_battle_belt_schematic", item="object/tangible/loot/loot_schematic/sep_battle_utility_belt_crafted_schematic.iff",cost=500},
	...
	installations = {
		...
		hq_s02_pvp_rebel = {type=factionRewardType.installation, display="@deed:hq_s02_pvp_rebel", item="object/tangible/deed/faction_perk/hq/hq_s02_pvp.iff", generatedObjectTemplate="object/building/faction_perk/hq/hq_s02_rebel_pvp.iff", cost=30000, bonus={"hq_s02_rebel","hq_s02_rebel"}, status = OVERT},
		...
		hq_s03_pvp_rebel = {type=factionRewardType.installation, display="@deed:hq_s03_pvp_rebel", item="object/tangible/deed/faction_perk/hq/hq_s03_pvp.iff", generatedObjectTemplate="object/building/faction_perk/hq/hq_s03_rebel_pvp.iff", cost=40000, bonus={"hq_s03_rebel","hq_s03_rebel"}, status = OVERT},
		...
		hq_s04_pvp_rebel = {type=factionRewardType.installation, display="@deed:hq_s04_pvp_rebel", item="object/tangible/deed/faction_perk/hq/hq_s04_pvp.iff", generatedObjectTemplate="object/building/faction_perk/hq/hq_s04_rebel_pvp.iff", cost=50000, bonus={"hq_s04_rebel","hq_s04_rebel"}, status = OVERT},
		...
		hq_s05_pvp_rebel = {type=factionRewardType.installation, display="@deed:hq_s05_pvp_rebel", item="object/tangible/deed/faction_perk/hq/hq_s05_pvp.iff", generatedObjectTemplate="object/building/faction_perk/hq/hq_s05_rebel_pvp.iff", cost=60000, bonus={"hq_s05_rebel","hq_s05_rebel"}, status = OVERT},
...
imperialRewardData = {
	...
	weaponsArmor = {
			armor_clonetrooper_bicep_l = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_bicep_l_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_bicep_l_crafted_schematic.iff",cost=10000},
			armor_clonetrooper_bicep_r = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_bicep_r_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_bicep_r_crafted_schematic.iff",cost=10000},
			armor_clonetrooper_boots = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_boots_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_boots_crafted_schematic.iff",cost=10000},
			armor_clonetrooper_chest_plate = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_chest_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_chest_plate_crafted_schematic.iff", cost=10000},
			armor_clonetrooper_helmet = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_helmet_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_helmet_crafted_schematic.iff", cost=10000},
			armor_clonetrooper_leggings = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_leggings_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_leggings_crafted_schematic.iff",cost=10000},
			armor_clonetrooper_bracer_l = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_bracer_l_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_bracer_l_crafted_schematic.iff",cost=10000},
			armor_clonetrooper_bracer_r = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_bracer_r_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_bracer_r_crafted_schematic.iff",cost=10000},
			armor_clonetrooper_gloves = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_gloves_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_gloves_crafted_schematic.iff",cost=10000},
			armor_clonetrooper_utility_belt = { type=factionRewardType.armor, display="@craft_item_ingredients_n:armor_clonetrooper_belt_schematic", item="object/tangible/loot/loot_schematic/clonetrooper_utility_belt_crafted_schematic.iff",cost=500},
		...
		--armor_212_bicep_l = { type=factionRewardType.armor, display="@wearables_name:armor_clonetrooper_b_bicep_l", item="object/tangible/wearables/armor/clone_trooper/armor_clone_trooper_imperial_s01_bicep_l.iff",cost=10000},
		--armor_212_bicep_r = { type=factionRewardType.armor, display="@wearables_name:armor_clonetrooper_b_bicep_r", item="object/tangible/wearables/armor/clone_trooper/armor_clone_trooper_imperial_s01_bicep_r.iff",cost=10000},
		--armor_212_boots = { type=factionRewardType.armor, display="@wearables_name:armor_clonetrooper_b_boots", item="object/tangible/wearables/armor/clone_trooper/armor_clone_trooper_imperial_s01_boots.iff",cost=10000},
		--armor_212_chest_plate = { type=factionRewardType.armor, display="@wearables_name:armor_clonetrooper_b_chest_plate", item="object/tangible/wearables/armor/clone_trooper/armor_clone_trooper_imperial_s01_chest_plate.iff", cost=10000},
