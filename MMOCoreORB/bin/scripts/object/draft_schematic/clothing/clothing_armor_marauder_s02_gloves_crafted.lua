...
object_draft_schematic_clothing_clothing_armor_marauder_s02_gloves_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s02_gloves_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Recon Armor Gloves",
   ...
   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s02_gloves.iff",
   
}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s02_gloves_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s02_gloves.iff")
