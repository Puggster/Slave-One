...
object_draft_schematic_clothing_clothing_armor_marauder_s01_chest_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s01_chest_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Battle Armor Helmet",
   ...
   resourceQuantities = {75, 75, 50, 60, 50, 40, 1, 3, 3},
   contribution = {80, 80, 80, 80, 80, 80, 100, 80, 80},


   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s01_chest_plate.iff",
   

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s01_chest_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s01_chest.iff")
