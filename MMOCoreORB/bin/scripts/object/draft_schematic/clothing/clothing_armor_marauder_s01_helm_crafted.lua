...
object_draft_schematic_clothing_clothing_armor_marauder_s01_helm_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s01_helm_crafted:new {
   ...
   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s01_helmet.iff",
   

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s01_helm_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s01_helm.iff")
