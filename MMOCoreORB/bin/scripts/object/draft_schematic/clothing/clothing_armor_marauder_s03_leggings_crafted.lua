...
object_draft_schematic_clothing_clothing_armor_marauder_s03_leggings_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s03_leggings_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Assault Armor Leggings",
   ...
   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s03_leggings.iff",
   

}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s03_leggings_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s03_leggings.iff")
