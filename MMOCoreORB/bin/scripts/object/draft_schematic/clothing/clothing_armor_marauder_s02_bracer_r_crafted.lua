...
object_draft_schematic_clothing_clothing_armor_marauder_s02_bracer_r_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s02_bracer_r_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Recon Armor Right Bracer",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s02_bracer_r_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s02_bracer_r.iff")
