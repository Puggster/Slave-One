...
object_draft_schematic_clothing_clothing_armor_marauder_s03_chest_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s03_chest_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Assault Armor Chest",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s03_chest_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s03_chest.iff")
