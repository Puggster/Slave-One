...
object_draft_schematic_clothing_clothing_armor_marauder_s03_helm_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s03_helm_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Recon Armor Helmet",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s03_helm_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s03_helm.iff")
