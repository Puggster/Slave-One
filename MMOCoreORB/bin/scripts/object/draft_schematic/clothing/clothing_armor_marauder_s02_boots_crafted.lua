...
object_draft_schematic_clothing_clothing_armor_marauder_s02_boots_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s02_boots_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Recon Armor Boots",
...
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s02_boots_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s02_boots.iff")
