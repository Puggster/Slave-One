...
object_draft_schematic_clothing_clothing_armor_marauder_s03_bracer_r_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s03_bracer_r_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Assault Armor Right Bracer",
   ...
   resourceQuantities = {50, 50, 25, 30, 20, 20, 1, 3, 3},
   contribution = {80, 80, 80, 80, 80, 80, 100, 80, 80},


   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s03_bracer_r.iff",
   
}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s03_bracer_r_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s03_bracer_r.iff")
