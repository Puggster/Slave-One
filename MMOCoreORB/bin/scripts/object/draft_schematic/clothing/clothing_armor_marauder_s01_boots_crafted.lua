...
object_draft_schematic_clothing_clothing_armor_marauder_s01_boots_crafted = object_draft_schematic_clothing_shared_clothing_armor_marauder_s01_boots_crafted:new {
   templateType = DRAFTSCHEMATIC,

   customObjectName = "Marauder Battle Armor Boots",
   ...
   targetTemplate = "object/tangible/wearables/armor/marauder/armor_marauder_s02_boots.iff",
   
}
ObjectTemplates:addTemplate(object_draft_schematic_clothing_clothing_armor_marauder_s01_boots_crafted, "object/draft_schematic/clothing/clothing_armor_marauder_s01_boots.iff")
