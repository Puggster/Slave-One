...
object_draft_schematic_vehicle_civilian_xj6_speeder = object_draft_schematic_vehicle_civilian_shared_xj6_speeder:new {
	...
	additionalTemplates = {
		"object/tangible/deed/vehicle_deed/shared_xj6_air_speeder_deed.iff",
	}
}
ObjectTemplates:addTemplate(object_draft_schematic_vehicle_civilian_xj6_speeder, "object/draft_schematic/vehicle/civilian/xj6_speeder.iff")
