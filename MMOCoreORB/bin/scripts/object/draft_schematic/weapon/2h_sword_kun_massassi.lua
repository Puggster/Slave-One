...
object_draft_schematic_weapon_2h_sword_kun_massassi = object_draft_schematic_weapon_shared_2h_sword_kun_massassi:new {
   ...
   customObjectName = "Massassi Enforcer Blade Schematic",
   ...
   resourceTypes = {"steel_arveshian", "aluminum_phrik", "object/tangible/component/weapon/shared_sword_core.iff"},
   resourceQuantities = {80, 60, 3},
