...
object_draft_schematic_weapon_lance_kaminoan = object_draft_schematic_weapon_shared_lance_kaminoan:new {
   ...
   resourceTypes = {"steel_arveshian", "copper_polysteel", "metal", "object/tangible/component/weapon/shared_vibro_unit.iff", "object/tangible/component/weapon/shared_vibrovis.iff"},
   resourceQuantities = {70, 35, 20, 2, 1},
