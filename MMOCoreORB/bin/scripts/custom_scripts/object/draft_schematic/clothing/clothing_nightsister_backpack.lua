object_draft_schematic_clothing_clothing_nightsister_backpack = object_draft_schematic_clothing_shared_clothing_nightsister_backpack:new {
   ...
   resourceTypes = {"object/tangible/component/clothing/shared_nightsister_cargo_pocket.iff", "object/tangible/component/clothing/shared_nightsister_cargo_pocket.iff", "hide", "metal"},
   resourceQuantities = {1, 1, 55, 25},
   contribution = {100, 100, 100, 100},


   targetTemplate = "object/tangible/tcg/series5/nightsister_backpack.iff",
