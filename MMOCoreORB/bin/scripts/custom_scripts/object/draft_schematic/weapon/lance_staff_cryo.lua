...
object_draft_schematic_weapon_lance_staff_cryo = object_draft_schematic_weapon_shared_lance_staff_cryo:new {
   ...
   resourceTypes = {"steel_ditanium", "copper_polysteel", "metal", "object/tangible/component/weapon/shared_vibro_unit_nightsister.iff", "object/tangible/component/weapon/shared_vibrovis.iff"},
