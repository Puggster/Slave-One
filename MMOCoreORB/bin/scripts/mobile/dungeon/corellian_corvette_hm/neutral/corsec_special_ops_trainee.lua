corsec_special_ops_trainee_hm = Creature:new {
	...
	baseHAMmax = 22500,
	armor = 1,
	resists = {35,35,30,25,80,30,25,35,25},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
...
CreatureTemplates:addCreatureTemplate(corsec_special_ops_trainee_hm, "corsec_special_ops_trainee_hm")
