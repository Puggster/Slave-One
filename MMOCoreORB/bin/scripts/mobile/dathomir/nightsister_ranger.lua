	...
	lootGroups = {
		{
			groups = {
				...
				--{group = "nightsister_clothing_schem_shirts", chance = 1750000},
				{group = "nightsister_clothing_schem_misc", chance = 500000},
				{group = "nightsister_clothing_schem_pants", chance = 2500000},
