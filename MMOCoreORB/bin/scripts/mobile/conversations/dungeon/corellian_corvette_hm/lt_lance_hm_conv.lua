corvetteHMLtLanceConvoTemplate = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "ticketTakerLtLanceHMConvoHandler",
	screens = {}
}
...
corvetteHMLtLanceConvoTemplate:addScreen(start);
...
corvetteHMLtLanceConvoTemplate:addScreen(goodbye);
...
corvetteHMLtLanceConvoTemplate:addScreen(too_many);
...
corvetteHMLtLanceConvoTemplate:addScreen(wrong_faction);
...
corvetteHMLtLanceConvoTemplate:addScreen(wrong_faction_too_many);
...
corvetteHMLtLanceConvoTemplate:addScreen(continue);
...
corvetteHMLtLanceConvoTemplate:addScreen(goodbye2);
...
corvetteHMLtLanceConvoTemplate:addScreen(mission_too_many);
...
corvetteHMLtLanceConvoTemplate:addScreen(mission_wrong_faction);
...
corvetteHMLtLanceConvoTemplate:addScreen(mission_wrong_faction_too_many);
...
corvetteHMLtLanceConvoTemplate:addScreen(mission);
...
corvetteHMLtLanceConvoTemplate:addScreen(authorization);
...
corvetteHMLtLanceConvoTemplate:addScreen(goodbye3);

addConversationTemplate("corvetteHMLtLanceConvoTemplate", corvetteHMLtLanceConvoTemplate);
