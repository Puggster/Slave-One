corvetteHMDS297ConvoTemplate = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "ticketTakerDS297HMConvoHandler",
	screens = {}
}
...
corvetteHMDS297ConvoTemplate:addScreen(start);
...
corvetteHMDS297ConvoTemplate:addScreen(goodbye);
...
corvetteHMDS297ConvoTemplate:addScreen(too_many);
...
corvetteHMDS297ConvoTemplate:addScreen(wrong_faction);
...
corvetteHMDS297ConvoTemplate:addScreen(wrong_faction_too_many);
...
corvetteHMDS297ConvoTemplate:addScreen(continue);
...
corvetteHMDS297ConvoTemplate:addScreen(goodbye2);
...
corvetteHMDS297ConvoTemplate:addScreen(mission_too_many);
...
corvetteHMDS297ConvoTemplate:addScreen(mission_wrong_faction);
...
corvetteHMDS297ConvoTemplate:addScreen(mission_wrong_faction_too_many);
...
corvetteHMDS297ConvoTemplate:addScreen(mission);
...
corvetteHMDS297ConvoTemplate:addScreen(authorization);
...
corvetteHMDS297ConvoTemplate:addScreen(goodbye3);

addConversationTemplate("corvetteHMDS297ConvoTemplate", corvetteHMDS297ConvoTemplate);
