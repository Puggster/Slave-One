corvetteHMKlaatuConvoTemplate = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "ticketTakerKlaatuHMConvoHandler",
	screens = {}
}
...
corvetteHMKlaatuConvoTemplate:addScreen(start);
...
corvetteHMKlaatuConvoTemplate:addScreen(goodbye);
...
corvetteHMKlaatuConvoTemplate:addScreen(too_many);
...
corvetteHMKlaatuConvoTemplate:addScreen(continue);
...
corvetteHMKlaatuConvoTemplate:addScreen(goodbye2);
...
corvetteHMKlaatuConvoTemplate:addScreen(mission_too_many);
...
corvetteHMKlaatuConvoTemplate:addScreen(mission);
...
corvetteHMKlaatuConvoTemplate:addScreen(authorization);
...
corvetteHMKlaatuConvoTemplate:addScreen(goodbye3);

addConversationTemplate("corvetteHMKlaatuConvoTemplate", corvetteHMKlaatuConvoTemplate);
