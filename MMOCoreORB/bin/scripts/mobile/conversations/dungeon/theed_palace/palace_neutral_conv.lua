palaceNeutralConvoTemplate = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "ticketTakerPalaceNeutralConvoHandler",
	screens = {}
}
...
palaceNeutralConvoTemplate:addScreen(start);
...
palaceNeutralConvoTemplate:addScreen(goodbye);
...
palaceNeutralConvoTemplate:addScreen(too_many);
...
palaceNeutralConvoTemplate:addScreen(continue);
...
palaceNeutralConvoTemplate:addScreen(goodbye2);
...
palaceNeutralConvoTemplate:addScreen(mission_too_many);
...
palaceNeutralConvoTemplate:addScreen(mission);
...
palaceNeutralConvoTemplate:addScreen(authorization);
...
palaceNeutralConvoTemplate:addScreen(goodbye3);

addConversationTemplate("palaceNeutralConvoTemplate", palaceNeutralConvoTemplate);
