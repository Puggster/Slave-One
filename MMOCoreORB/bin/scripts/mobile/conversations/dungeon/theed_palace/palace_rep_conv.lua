palaceRepConvoTemplate = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "ticketTakerPalaceRepConvoHandler",
	screens = {}
}
...
palaceRepConvoTemplate:addScreen(start);
...
palaceRepConvoTemplate:addScreen(goodbye);
...
palaceRepConvoTemplate:addScreen(too_many);
...
palaceRepConvoTemplate:addScreen(wrong_faction);
...
palaceRepConvoTemplate:addScreen(wrong_faction_too_many);
...
palaceRepConvoTemplate:addScreen(continue);
...
palaceRepConvoTemplate:addScreen(goodbye2);
...
palaceRepConvoTemplate:addScreen(mission_too_many);
...
palaceRepConvoTemplate:addScreen(mission_wrong_faction);
...
palaceRepConvoTemplate:addScreen(mission_wrong_faction_too_many);
...
palaceRepConvoTemplate:addScreen(mission);
...
palaceRepConvoTemplate:addScreen(authorization);
...
palaceRepConvoTemplate:addScreen(goodbye3);

addConversationTemplate("palaceRepConvoTemplate", palaceRepConvoTemplate);
