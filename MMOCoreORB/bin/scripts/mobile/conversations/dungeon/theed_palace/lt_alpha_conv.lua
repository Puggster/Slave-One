palaceLtAlphaConvoTemplate = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "ticketTakerLtAlphaConvoHandler",
	screens = {}
}
...
palaceLtAlphaConvoTemplate:addScreen(start);
...
palaceLtAlphaConvoTemplate:addScreen(goodbye);
...
palaceLtAlphaConvoTemplate:addScreen(too_many);
...
palaceLtAlphaConvoTemplate:addScreen(wrong_faction);
...
palaceLtAlphaConvoTemplate:addScreen(wrong_faction_too_many);
...
palaceLtAlphaConvoTemplate:addScreen(continue);
...
palaceLtAlphaConvoTemplate:addScreen(goodbye2);
...
palaceLtAlphaConvoTemplate:addScreen(mission_too_many);
...
palaceLtAlphaConvoTemplate:addScreen(mission_wrong_faction);
...
palaceLtAlphaConvoTemplate:addScreen(mission_wrong_faction_too_many);
...
palaceLtAlphaConvoTemplate:addScreen(mission);
...
palaceLtAlphaConvoTemplate:addScreen(authorization);
...
palaceLtAlphaConvoTemplate:addScreen(goodbye3);

addConversationTemplate("palaceLtAlphaConvoTemplate", palaceLtAlphaConvoTemplate);
