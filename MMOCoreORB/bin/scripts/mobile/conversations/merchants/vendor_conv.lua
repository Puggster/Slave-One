...
RestussRepVendorConvoTemplate = VendorConvoTemplate:new {
	luaClassHandler = "RestussRepVendorConvoHandler"
}

addConversationTemplate("RestussRepVendorConvoTemplate", RestussRepVendorConvoTemplate);
