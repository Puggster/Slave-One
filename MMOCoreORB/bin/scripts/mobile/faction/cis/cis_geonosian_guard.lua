cis_geonosian_guard = Creature:new {
	customName = "a Separatist Geonosian guard",
		...
		lootGroups = {
			{
				groups = {
					...
					{group = "noob_weapons", chance = 4250000},
...
CreatureTemplates:addCreatureTemplate(cis_geonosian_guard, "cis_geonosian_guard")
