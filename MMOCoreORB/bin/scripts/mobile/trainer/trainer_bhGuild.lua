trainer_bhGuild = Creature:new {
	customName = "a Bounty Hunter Guild Trainer",
	...
	conversationTemplate = "bhGuildTrainerConvoTemplate",
...
CreatureTemplates:addCreatureTemplate(trainer_bhGuild, "trainer_bhGuild")
