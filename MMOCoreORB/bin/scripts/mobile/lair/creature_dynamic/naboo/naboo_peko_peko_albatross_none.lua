naboo_peko_peko_albatross_none = Lair:new {
	mobiles = {{"peko_peko",1},{"giant_peko_peko",1},{"peko_peko_albatross",1}},
	spawnLimit = 15,
...
addLairTemplate("naboo_peko_peko_albatross_none", naboo_peko_peko_albatross_none)
