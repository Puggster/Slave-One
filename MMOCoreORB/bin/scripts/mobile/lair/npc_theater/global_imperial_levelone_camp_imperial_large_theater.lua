global_imperial_levelone_camp_imperial_large_theater = Lair:new {
	mobiles = {
		{"clone_commando",7},
		{"rep_jedi_knight",5},
		{"clonetrooper_squad_leader",4},
		{"clonetrooper",6},
		{"clonetrooper_captain",4}
	},
	spawnLimit = 32,
...
addLairTemplate("global_imperial_levelone_camp_imperial_large_theater", global_imperial_levelone_camp_imperial_large_theater)
